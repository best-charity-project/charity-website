...
class AdminAddNews extends Component {
      ...
      <React.Fragment>
        {!this.state.isPreview ? (
          <div className="create-news">
            ...
            <div className="text-news">
              ...
              <div className="admin-textarea">
                ...
                <div className="admin-textarea-description">
                  <span>
                    Краткое описание не должно содержать более 300 символов
                  </span>
                  <div>
            ...
            <div
              className={
                this.state.socialNetworksModal && !this.props.location.state
                  ? "overlay"
                  : "overlay hidden"
              }
            >
              <div className="modal-event-field modal-social-event">
                <div>
                  ...
                  <ul
                    className="social-networks-event-modal"
                    onClick={this.getActiveSocialNetworks}
                  >
                    <li className="vkontakte-social-network" />
                    <li className="facebook-social-network" />
                  </ul>
                </div>
  ...
  onCorrectFullText = () => {
    if (
      convertToRaw(this.state.fullTextEditorState.getCurrentContent()).blocks[0]
        .text
    ) {
      this.setState({
        isFullTextCorrect: true
  ...
  getTextofPost = () => {
    ...
    let textfromEditor = convertToRaw(
      this.state.fullTextEditorState.getCurrentContent()
    ).blocks;
    let info = "";
