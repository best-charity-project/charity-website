...
class AdminUploadImage extends Component {
  ...
  componentWillMount() {
    if (this.props.imageData) this.setState({ image: this.props.imageData });
      ...
      <div>
        ...
        <div className="position-cropper">
          ...
          <div>
            ...
            {this.state.loaded ? (
              <div>
                <button onClick={this.handleClick} className="admin-button">
                  Обрезать
                </button>
            ...
            {this.state.image ? (
              <div className="admin-title-image">
                <img className="after-img" src={this.state.image} alt="" />
                <Button
