  ...
  <div className="admin indent">
    {userInfo.admin && (
      <div className="sidebar">
        ...
        <Switch>
          <Route path={`${match.url}/news/edit/:id`} render={() => <EditNews showMessage={showMessage} />} />
          <Route exact path={`${match.url}/news`} render={() => <AdminNews showMessage={showMessage} />} />
          <Route path={`${match.url}/addNews`} render={() => <AddNews showMessage={showMessage} />} />
          <Route path={`${match.url}/calendar`} render={() => <AddEvent showMessage={showMessage} />} />
          <Route path={`${match.url}/library`} render={() => <AdminLibrary showMessage={showMessage} />} />
          <Route path={`${match.url}/organizations`} render={() => <AdminOrganizations showMessage={showMessage} />} />
